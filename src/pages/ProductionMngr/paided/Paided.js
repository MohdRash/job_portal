...
const PaidedStudents = ({ history }) => {
  ...
  useEffect(() => {
    dispatch(getProductionmngrs(searchText, pageSend(), "paid"))
  }, [dispatch, page, searchText, "paid"])
  ...
  return (
    ...
    <>
      <MetaTags>
        <title>Fee Paided Students | Career </title>
      </MetaTags>
      <div className="page-content">
        <Breadcrumbs
          title="Dashboard"
          breadcrumbItem="Fee Paided Students"
        />
        <Container fluid>
...
export default PaidedStudents

PaidedStudents.propTypes = {
