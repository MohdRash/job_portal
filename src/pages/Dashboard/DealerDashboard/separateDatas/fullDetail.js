            ...
            <div key={index}>
              ...
              <div className="page-content">
                ...
                <Container fluid>
                      ...
                      <CardBody>
                        <Row>
                          ...
                          <Col lg="6" md="6" className="pt-2">
                            <Media>
                              <div>
                                <Label style={{fontWeight: '400', fontSize: '12px'}}>VISA Expiry Date</Label>
                    ...
                    <h4 className="pt-3" style={{fontWeight: '400', fontSize: '16px'}}>Student Info:</h4>
                    <Card>
                      <CardBody>
                        <Row>
                          <Col lg="4" md="4" sm="6" className="mb-4">

                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Address</Label>
                            <h5 className="mb-1">
                          ...
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Contact Number</Label>
                            <h5 className="mb-1">
                              {item?.phone || 'no data provided'}
                            </h5>
                          </Col>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Univerity</Label>
                            <h5 className="mb-1">
                              {item?.university || 'no data provided'}
                            </h5>
                          </Col>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Campus</Label>
                            <h5 className="mb-1">
                          ...
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Course Name</Label>
                            <h5 className="mb-1">
                              {item?.course_title || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Course Start Date</Label>
                            <h5 className="mb-1">
                              {item?.course_start_date || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Course End Date</Label>
                            <h5 className="mb-1">
                              {item?.course_end_date || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>LinkedIn username</Label>
                            <h5 className="mb-1">
                              {item?.linkedin_username || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>LinkedIn password</Label>
                            <h5 className="mb-1">
                    ...
                    <h4 className="pt-3" style={{fontWeight: '400', fontSize: '16px'}}>Specialized In:</h4>
                    <Card>
                      <CardBody>
                        <div className="table-responsive mb-4">
                          <Table className="table mb-5 vh-200 table-bordered">
                            ...
                            <tbody className="text-center">
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 1</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item.specialization[0]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[0]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 2</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[1]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[1]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 3</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[2]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[2]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 4</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[3]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[3]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 5</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[4]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[4]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 6</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[5]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[5]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 7</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[6]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[6]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 8</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[7]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[7]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 9</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[8]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[8]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 10</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[9]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[9]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 11</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[10]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[10]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 12</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[11]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[11]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 13</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[12]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[12]?.status}</td>
                              </tr>
                              <tr>
                                <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 14</th>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[13]?.title}</td>
                                <td style={{fontWeight: '500', fontSize: '13px'}}>{item?.specialization[13]?.status}</td>
                              </tr>
                            </tbody>
                          </Table>
                        </div>
                    ...
                    <h4 className="pt-3" style={{fontWeight: '400', fontSize: '16px'}}>Application Info:</h4>
                    <Card>
                      <CardBody>
                        <Row>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Applied Company Name</Label>
                            <h5 className="mb-1">
                              {item?.company_name || 'no data provided'}
                            </h5>
                          </Col>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Exp. Certificates Submision Date</Label>
                            <h5 className="mb-1">
                              {item?.expr_certi_submit_date || 'no data provided'}
                            </h5>
                          </Col>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Contract Submision Date</Label>
                            <h5 className="mb-1">
                              {item?.contract_submit_date || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Work Type</Label>
                            <h5 className="mb-1">
                              {item?.working_type || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Work Duration</Label>
                            <h5 className="mb-1">
                    ...
                    <h4 className="pt-3" style={{fontWeight: '400', fontSize: '16px'}}>Job Roles:</h4>
                    <Card>
                      <CardBody>
                        <Row>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>First Job Role</Label>
                            <h5 className="mb-1">
                              {item?.first_job_role || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>First Job Sector</Label>
                            <h5 className="mb-1">
                              {item?.first_job_sector || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Reason For Choosing {item?.first_job_sector}</Label>
                            <h5 className="mb-1">
                        ...
                        <Row>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Second Job Role</Label>
                            <h5 className="mb-1">
                              {item?.second_job_role || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Second Job Sector</Label>
                            <h5 className="mb-1">
                              {item?.second_job_sector || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Reason For Choosing {item?.second_job_sector}</Label>
                            <h5 className="mb-1">
                        ...
                        <Row>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Third Job Role</Label>
                            <h5 className="mb-1">
                              {item?.third_job_role || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Third Job Sector</Label>
                            <h5 className="mb-1">
                              {item?.third_job_sector || 'no data provided'}
                            </h5>
                          </Col>
                          <Col className="mt-2" lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Reason For Choosing {item?.third_job_sector}</Label>
                            <h5 className="mb-1">
                    ...
                    <Row className="pt-4">
                      <h4 style={{fontWeight: '400', fontSize: '16px'}}>Vacancies Available:</h4>
