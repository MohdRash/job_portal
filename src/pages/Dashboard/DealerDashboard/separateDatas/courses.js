            ...
            <div key={index}>
              ...
              <div className="page-content">
                ...
                <Container fluid>
                    ...
                    <h4 className="pt-3" style={{fontWeight: '400', fontSize: '16px'}}>Course Info:</h4>
                    <Card>
                      <CardBody>
                        <Row>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>University</Label>
                            <h5 className="mb-1">
                    ...
                    <Card>
                      <CardBody>
                        <Row>
                          <Col lg="4" md="4" sm="6">
                            <Label style={{fontWeight: '400', fontSize: '12px'}}>Internship/Placement</Label>
                            <h5 className="mb-1">
                            ...
                            <Table className="table mb-5 vh-200 table-bordered">
                              ...
                              <tbody className="text-center">
                                <tr>
                                  ...
                                  <td style={{fontWeight: '600'}}>{item.specialization[0]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[0]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 2</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[1]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[1]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 3</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[2]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[2]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 4</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[3]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[3]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 5</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[4]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[4]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 6</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[5]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[5]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 7</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[6]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[6]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 8</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[7]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[7]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 9</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[8]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[8]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 10</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[9]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[9]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 11</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[10]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[10]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 12</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[11]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[11]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 13</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[12]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[12]?.status}</td>
                                </tr>
                                <tr>
                                  <th scope="row" className="pt-4" style={{fontWeight: '400', fontSize: '12px'}}>Module 14</th>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[13]?.title}</td>
                                  <td style={{fontWeight: '600'}}>{item?.specialization[13]?.status}</td>
                                </tr>
                              </tbody>
                            </Table>
                          </div>
